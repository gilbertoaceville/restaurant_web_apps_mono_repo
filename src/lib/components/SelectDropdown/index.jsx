...
import { SelectDropdownWrapper } from "./SelectDropdown.styled";
...
const Select = ({ onChange, id, value, label, options = [] }) => {
  ...
  return (
    <div
      className={
        "select" +
        (active ? " select-active" : " select-deactivate") +
    ...
    >
      ...
      <div className="select__value" onClick={toggleActive}>
        <p>{value}</p>
      </div>
      ...
      <div className="select__trigger" onClick={toggleActive}></div>
    </div>
  );
};
